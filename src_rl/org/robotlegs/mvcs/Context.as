...
package org.robotlegs.mvcs
{
	...
	public class Context extends ContextBase implements IContext
	{
		...
		{
			if(_reflector==null) _reflector =new SwiftSuspendersReflector();
			return _reflector ;
		}
		...
		{
			if(_commandMap==null) _commandMap =new CommandMap(eventDispatcher, createChildInjector(), reflector);
			return _commandMap ;
		}
		...
		{
			if(_mediatorMap==null) _mediatorMap =new MediatorMap(contextView, createChildInjector(), reflector);
			return _mediatorMap ;
		}
		...
		{
			if(_viewMap==null) _viewMap =new ViewMap(contextView, injector);
			return _viewMap ;
		}
