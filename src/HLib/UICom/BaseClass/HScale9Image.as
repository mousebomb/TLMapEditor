...
package HLib.UICom.BaseClass
{
	 ...
	 */
	public class HScale9Image extends Sprite
	{
		/**
		 * @private
		 */
		 ...
		 * init object.
		 */
		public function init(textures:HScale9Textures, textureScale:Number = 1):void{
		 ...
		 * @private
		 */
		private var _textures:HScale9Textures;

		/**
		 * The textures displayed by this image.
		 */
		public function get textures():HScale9Textures
		{
		 ...
		 * @private
		 */
		public function set textures(value:HScale9Textures):void
		{
			if(!value)
			{
