...
package HLib.UICom.BaseClass
{
	 ...
	 * space.
	 */
	public class HScale3Image extends Sprite
	{
		/**
		 * @private
		 */
		 ...
		 * init object.
		 */
		public function init(textures:HScale3Textures, textureScale:Number = 1):void{
		 ...
		 * @private
		 */
		private var _textures:HScale3Textures;

		/**
		 * The textures displayed by this image.
		 */
		public function get textures():HScale3Textures
		{
		 ...
		 * @private
		 */
		public function set textures(value:HScale3Textures):void
		{
			if(!value)
			{
		...
		private function validate():void
		{
			...
			if(this._propertiesChanged || this._layoutChanged || this._renderingChanged)
			{
				...
				var image:Image;
				if(this._textures.direction == HScale3Textures.DIRECTION_VERTICAL)
				{
