package tl.mapeditor.ui.common
{
	...
	public class MySprite extends Sprite
	{
		...
		public function MySprite()  {  super(); _graphics = this.graphics; }
		 ...
		 */		
		public function drawRect($width:Number, $height:Number, $color:uint, $alpha:Number = 1, $actionX:Number = 0, $actionY:Number = 0, $isClear:Boolean = true):void
		{
			//清空绘制
			if($isClear) _graphics.clear();
			_graphics.beginFill($color, $alpha);
			_graphics.drawRect($actionX, $actionY, $width, $height);
			_graphics.endFill();
		}
		/**
		 * 根据bitmapdata绘制矩形
