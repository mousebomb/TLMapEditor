package tl.mapeditor.ui.controls
{
	...
	public class Gizmo3DBase extends ObjectContainer3D
	{
		...
		public function update():void
		{
			...
			var dist:Vector3D = TLMapEditor.view3D.camera.scenePosition.subtract(content.scenePosition);
			...
			ambientLight.direction = TLMapEditor.view3D.camera.forwardVector;
		...
		public function show(sceneObject:ObjectContainer3D):void
		{
			...
			this.transform = currentMesh.sceneTransform.clone();
