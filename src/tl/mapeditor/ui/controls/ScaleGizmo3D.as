package tl.mapeditor.ui.controls
{
	...
	{		
		...
		public function ScaleGizmo3D()
		{
			...
			var cubeGeom:CubeGeometry = new CubeGeometry(50, 50, 20, 1, 1, 1, true);
...
//			content.addChild(yCube);
		...
		protected function handleMouseDown(e:Event):void
		{
			...
			click.x = StageFrame.stage.mouseX;
			click.y = StageFrame.stage.mouseY;
...
//			CameraManager.active = false;
			...
			StageFrame.stage.addEventListener(MouseEvent.MOUSE_UP, handleMouseUp);
			StageFrame.stage.addEventListener(MouseEvent.MOUSE_MOVE, handleMouseMove);
		}
		
		protected function handleMouseMove(e:MouseEvent):void
		{	
			var dx:Number = StageFrame.stage.mouseX - click.x;
			var dy:Number = -(StageFrame.stage.mouseY - click.y);

			var cameraManagerRadius = 800;
			var trans:Number = (dx+dy) * 0.005 * cameraManagerRadius/maxBounds;
...
//			Scene3DManager.updateDefaultCameraFarPlane();
		...
		{
			isMoving = false;
			StageFrame.stage.removeEventListener(MouseEvent.MOUSE_UP, handleMouseUp);
			StageFrame.stage.removeEventListener(MouseEvent.MOUSE_MOVE, handleMouseMove);
